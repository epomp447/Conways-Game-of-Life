...
//                if (mBoard[i][j]==true) {
//                    System.out.println("mBoard:" + "[" + i + "]" + "[" + j + "] has " + countNeighbors(i, j) + " neighbors");
//                }
//            }
//        }
...
//        mBoard[31][32] = true;
//        mBoard[1][1] = true;
//        mBoard[mBoardH-2][mBoardW-2] = true;
//        mBoard[1][mBoardW-2] = true;
//        mBoard[mBoardH-2][1] = true;
    ...
    public void nextGeneration ( ) {
        ...
        for (int i=1; i < mBoardH-1;i++) {
            for (int j = 1; j < mBoardW-1; j++) {
